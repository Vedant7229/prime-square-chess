...
export default function About() {
  return (
    <main className="flex flex-col">
      {/* 1. Hero Section */}
      <section className="py-16 md:py-24 px-6 md:px-margin-desktop max-w-container-max mx-auto mt-12 md:mt-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div>
            <div className="inline-flex items-center gap-3 mb-6">
              ...
              <MaterialIcon name="chess" className="text-secondary" fill />
            </div>
            <h1 className="font-display text-4xl md:text-display-lg text-primary mb-8 max-w-xl">
              Where Young Minds Learn to Think Like Champions
            </h1>
            <div className="font-sans text-sm md:text-body-lg text-body-muted space-y-6 max-w-lg mb-8 leading-relaxed">
              <p>
            ...
            <Link
              href="/book"
              className="inline-block bg-primary text-on-primary px-8 py-4 rounded-lg font-button text-button hover:bg-primary-container active:scale-95 duration-150 transition-all shadow-sm text-center"
            >
              Book Free Trial
            </Link>
          </div>
          <div className="relative w-full aspect-[1.34] rounded-xl overflow-hidden shadow-lg border border-border-warm bg-primary/5">
            <video
        ...
        <div className="px-6 md:px-margin-desktop max-w-container-max mx-auto">
          <div className="text-center mb-20 max-w-3xl mx-auto">
            ...
            <div className="flex justify-center mb-6">
              <MaterialIcon name="chess" className="text-secondary text-4xl" fill />
            </div>
            <h2 className="font-display text-3xl md:text-display-lg text-primary leading-tight">
              A Passion Passed Through Generations
            </h2>
            <p className="font-sans text-sm md:text-body-lg text-body-muted mt-6 max-w-2xl mx-auto">
          ...
          <div className="space-y-24 md:space-y-32 max-w-5xl mx-auto">
            {/* Block 01 */}
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              <div className="relative aspect-[3/4] rounded-xl overflow-hidden shadow-md border border-border-warm max-w-sm mx-auto lg:mx-0 w-full">
                <Image
                  src={story1}
              ...
              <div className="flex flex-col items-start">
                <div className="flex items-center gap-4 mb-4">
                  <span className="font-display text-4xl text-secondary">01</span>
                  <div className="h-px w-16 bg-secondary/50"></div>
                </div>
                <h3 className="font-headline-md text-2xl md:text-3xl text-primary mb-6">
                  Where It All Began
                </h3>
                <div className="space-y-4 font-sans text-sm md:text-base text-body-muted leading-relaxed">
                  <p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              <div className="flex flex-col items-start order-2 lg:order-1">
                <div className="flex items-center gap-4 mb-4">
                  <span className="font-display text-4xl text-secondary">02</span>
                  <div className="h-px w-16 bg-secondary/50"></div>
                </div>
                <h3 className="font-headline-md text-2xl md:text-3xl text-primary mb-6">
              ...
              <div className="relative aspect-[3/4] rounded-xl overflow-hidden shadow-md border border-border-warm max-w-sm mx-auto lg:mx-0 order-1 lg:order-2 w-full">
                <Image
                  src={story2}
            ...
            {/* Block 03 */}
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              <div className="relative aspect-video rounded-xl overflow-hidden shadow-md border border-border-warm w-full">
                <Image
                  src={aboutHeroImg}
              ...
              <div className="flex flex-col items-start">
                <div className="flex items-center gap-4 mb-4">
                  <span className="font-display text-4xl text-secondary">03</span>
                  <div className="h-px w-16 bg-secondary/50"></div>
                </div>
                <h3 className="font-headline-md text-2xl md:text-3xl text-primary mb-6">
          ...
          <div className="mt-24 max-w-3xl mx-auto">
            <div className="bg-surface-white p-8 rounded-xl border-l-4 border-secondary shadow-sm text-center">
              <p className="font-sans text-base md:text-body-lg italic text-primary flex justify-center items-center gap-2">
                <MaterialIcon name="format_quote" className="text-secondary text-2xl rotate-180" />
      ...
      {/* 3. Meet the Coaches */}
      <section className="py-20 md:py-24 px-6 md:px-margin-desktop max-w-container-max mx-auto">
        <div className="text-center md:text-left mb-16">
          <h2 className="font-display text-3xl md:text-headline-lg text-primary">
            Meet the Coaches
          </h2>
          <p className="font-sans text-sm md:text-body-lg text-body-muted mt-3">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-12">
          {/* Amit Dalal */}
          <div className="flex flex-col md:flex-row gap-6 md:gap-8 items-center bg-surface-white p-6 md:p-8 border border-border-warm rounded-xl hover:shadow-md transition-shadow">
            <div className="relative w-full md:w-48 h-64 bg-surface-container-high rounded-lg overflow-hidden flex-shrink-0">
              <Image
                src={coachAmit}
            ...
            <div className="flex flex-col items-start">
              ...
              <p className="font-label-md text-xs md:text-sm text-secondary uppercase tracking-wider mt-1">
                Founder and Senior Chess Coach
              </p>
              <p className="font-sans text-sm text-body-muted mt-4 leading-relaxed">
      ...
      <section className="bg-surface-container py-20 md:py-24 border-y border-border-warm">
        <div className="px-6 md:px-margin-desktop max-w-container-max mx-auto">
          <div className="text-center mb-16 max-w-3xl mx-auto">
            <span className="font-label-md text-xs text-secondary uppercase tracking-[0.2em] mb-4 block">
              Our Teaching Philosophy
            </span>
            <h2 className="font-display text-3xl md:text-display-lg text-primary">
              Our 3 Principles
            </h2>
            ...
            <p className="font-sans text-sm md:text-body-lg text-body-muted">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Principle 1 */}
            <div className="bg-surface-white p-8 md:p-10 rounded-xl border border-border-warm text-center flex flex-col items-center hover:shadow-md transition-shadow">
              ...
              <p className="font-sans text-sm text-body-muted leading-relaxed">
            ...
            <div className="bg-surface-white p-8 md:p-10 rounded-xl border border-border-warm text-center flex flex-col items-center hover:shadow-md transition-shadow">
              <div className="w-16 h-16 bg-secondary/10 rounded-full flex items-center justify-center mb-6">
                <MaterialIcon name="groups" className="text-primary text-3xl" fill />
              </div>
              <h3 className="font-headline-md text-xl text-primary mb-4 font-semibold">
                Every Child Matters
              </h3>
      ...
      <section className="py-20 md:py-24 px-6 md:px-margin-desktop max-w-container-max mx-auto">
        <div className="text-center mb-16">
          ...
          <h2 className="font-display text-3xl md:text-display-lg text-primary mb-6">
          ...
          {[
            ...
            <div key={idx} className="text-center flex flex-col items-center">
              <div className="w-16 h-16 bg-secondary/10 rounded-full flex items-center justify-center mb-4">
                <MaterialIcon name={m.icon} className="text-secondary text-3xl" />
              </div>
              <div className="font-display text-3xl md:text-4xl text-primary font-normal mb-1">
                {m.num}
              </div>
              <div className="font-label-md text-xs md:text-sm text-on-surface font-semibold uppercase tracking-wider mb-1">
                {m.title}
              </div>
              <div className="font-sans text-xs text-body-muted">
                {m.desc}
              </div>
            </div>
          ))}
